...
**Last Updated:** 2026-08-14 03:29:17 UTC
...
|----------|-------------|-----------|-----------------|
| `accessories` | List of visible accessories. | 81.4% (616) | 336 |
| `age_group` | Visually estimated age bracket. | 88.5% (670) | 6 |
| `bottom_garment_type` | The type of bottom being worn. | 50.7% (384) | 201 |
| `brand_mentions` | Fashion brands explicitly mentioned. | 8.5% (64) | 43 |
| `clothing_fit` | The overall fit of the clothing. | 88.4% (669) | 4 |
| `clothing_style` | The primary fashion style. | 100.0% (757) | 173 |
| `color_palette_type` | The overall color theory of the outfit. | 88.5% (670) | 5 |
| `confidence_score` | Model confidence score (0.0 to 1.0). | 100.0% (757) | 8 |
| `date_scraped` | Automatically injected date. | 100.0% (757) | 62 |
| `fabric_textures` | Visually inferred materials. | 88.5% (670) | 219 |
| `focal_point` | The standout piece that draws the eye. | 88.5% (670) | 429 |
| `footwear_type` | The type of shoes being worn. | 31.7% (240) | 120 |
| `gender` | The perceived gender of the subject. | 100.0% (757) | 3 |
| `hair_color` | Subject's hair color. | 87.8% (665) | 62 |
| `hairstyle` | The primary hairstyle of the subject. | 100.0% (757) | 417 |
| `image_url` | Image URL of the subject (GDPR compliant). | 1.7% (13) | 12 |
| `is_trendsetter` | True if celebrity/model/artist, False if regular person. | 100.0% (757) | 2 |
| `layering_complexity` | Scale from 1 (simple) to 5 (heavy layering). | 88.5% (670) | 4 |
| `makeup_style` | Subject's makeup style. | 88.5% (670) | 28 |
| `patterns` | Patterns visible on the clothing. | 88.5% (670) | 154 |
| `pose_or_activity` | What the subject is doing. | 88.5% (670) | 198 |
| `price_segment` | Inferred price segment. | 88.5% (670) | 4 |
| `primary_colors` | List of dominant colors in the outfit. | 100.0% (757) | 75 |
| `region` | Geographic region identified from context ('EU' or 'US'). | 100.0% (757) | 2 |
| `seasonality` | The inferred season. | 88.5% (670) | 5 |
| `sentiment_or_vibe` | The aesthetic vibe described. | 88.2% (668) | 295 |
| `setting` | The setting or background of the photo. | 88.5% (670) | 5 |
| `source_url` | The URL of the webpage where the image was found. | 100.0% (757) | 135 |
| `top_garment_type` | The type of top being worn. | 87.5% (662) | 371 |
| `weather_conditions` | Inferred weather. | 69.6% (527) | 29 |
