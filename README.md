...
**Last Updated:** 2026-08-15 02:22:04 UTC
...
|----------|-------------|-----------|-----------------|
| `accessories` | List of visible accessories. | 81.5% (627) | 340 |
| `age_group` | Visually estimated age bracket. | 88.7% (682) | 6 |
| `bottom_garment_type` | The type of bottom being worn. | 50.3% (387) | 202 |
| `brand_mentions` | Fashion brands explicitly mentioned. | 8.7% (67) | 43 |
| `clothing_fit` | The overall fit of the clothing. | 88.6% (681) | 4 |
| `clothing_style` | The primary fashion style. | 100.0% (769) | 176 |
| `color_palette_type` | The overall color theory of the outfit. | 88.7% (682) | 5 |
| `confidence_score` | Model confidence score (0.0 to 1.0). | 100.0% (769) | 8 |
| `date_scraped` | Automatically injected date. | 100.0% (769) | 63 |
| `fabric_textures` | Visually inferred materials. | 88.7% (682) | 221 |
| `focal_point` | The standout piece that draws the eye. | 88.7% (682) | 438 |
| `footwear_type` | The type of shoes being worn. | 31.2% (240) | 120 |
| `gender` | The perceived gender of the subject. | 100.0% (769) | 3 |
| `hair_color` | Subject's hair color. | 88.0% (677) | 63 |
| `hairstyle` | The primary hairstyle of the subject. | 100.0% (769) | 423 |
| `image_url` | Image URL of the subject (GDPR compliant). | 1.7% (13) | 12 |
| `is_trendsetter` | True if celebrity/model/artist, False if regular person. | 100.0% (769) | 2 |
| `layering_complexity` | Scale from 1 (simple) to 5 (heavy layering). | 88.7% (682) | 4 |
| `makeup_style` | Subject's makeup style. | 88.7% (682) | 29 |
| `patterns` | Patterns visible on the clothing. | 88.7% (682) | 155 |
| `pose_or_activity` | What the subject is doing. | 88.7% (682) | 202 |
| `price_segment` | Inferred price segment. | 88.7% (682) | 4 |
| `primary_colors` | List of dominant colors in the outfit. | 100.0% (769) | 76 |
| `region` | Geographic region identified from context ('EU' or 'US'). | 100.0% (769) | 2 |
| `seasonality` | The inferred season. | 88.7% (682) | 5 |
| `sentiment_or_vibe` | The aesthetic vibe described. | 88.4% (680) | 303 |
| `setting` | The setting or background of the photo. | 88.7% (682) | 5 |
| `source_url` | The URL of the webpage where the image was found. | 100.0% (769) | 136 |
| `top_garment_type` | The type of top being worn. | 87.6% (674) | 374 |
| `weather_conditions` | Inferred weather. | 69.8% (537) | 29 |
