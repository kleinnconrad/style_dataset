...
**Last Updated:** 2026-09-09 05:48:17 UTC
...
|----------|-------------|-----------|-----------------|
| `accessories` | List of visible accessories. | 85.0% (932) | 435 |
| `age_group` | Visually estimated age bracket. | 92.1% (1009) | 6 |
| `bottom_garment_type` | The type of bottom being worn. | 53.6% (588) | 270 |
| `brand_mentions` | Fashion brands explicitly mentioned. | 9.4% (103) | 66 |
| `clothing_fit` | The overall fit of the clothing. | 91.9% (1007) | 4 |
| `clothing_style` | The primary fashion style. | 100.0% (1096) | 229 |
| `color_contrast_strategy` | How colors are paired. | 26.0% (285) | 5 |
| `color_palette_type` | The overall color theory of the outfit. | 92.1% (1009) | 5 |
| `confidence_score` | Model confidence score (0.0 to 1.0). | 100.0% (1096) | 10 |
| `date_scraped` | Automatically injected date. | 100.0% (1096) | 88 |
| `embellishments` | Visible decorative details. | 6.2% (68) | 50 |
| `fabric_textures` | Visually inferred materials. | 91.9% (1007) | 272 |
| `focal_point` | The standout piece that draws the eye. | 91.9% (1007) | 624 |
| `footwear_type` | The type of shoes being worn. | 32.5% (356) | 147 |
| `gender` | The perceived gender of the subject. | 100.0% (1096) | 3 |
| `hair_accessories` | Specific hair accessories. | 0.8% (9) | 6 |
| `hair_color` | Subject's hair color. | 91.0% (997) | 69 |
| `hair_finish` | The styling finish of the hair. | 25.9% (284) | 6 |
| `hair_parting` | How the hair is parted. | 25.9% (284) | 5 |
| `hairstyle` | The primary hairstyle of the subject. | 100.0% (1096) | 555 |
| `hardware_details` | Visible metal or structural components. | 12.7% (139) | 66 |
| `hemline_length` | The hemline length for bottoms. | 9.6% (105) | 5 |
| `image_url` | Image URL of the subject (GDPR compliant). | 1.2% (13) | 12 |
| `is_trendsetter` | True if celebrity/model/artist, False if regular person. | 100.0% (1096) | 2 |
| `layering_complexity` | Scale from 1 (simple) to 5 (heavy layering). | 92.0% (1008) | 4 |
| `makeup_style` | Subject's makeup style. | 92.0% (1008) | 35 |
| `material_finish` | The optical quality of the fabrics. | 25.9% (284) | 4 |
| `neckline_style` | The cut of the top/dress around the neck. | 24.2% (265) | 5 |
| `occasion` | Intended event or setting for the outfit. | 26.1% (286) | 5 |
| `patterns` | Patterns visible on the clothing. | 92.0% (1008) | 188 |
| `pose_or_activity` | What the subject is doing. | 92.0% (1008) | 242 |
| `price_segment` | Inferred price segment. | 92.1% (1009) | 4 |
| `primary_colors` | List of dominant colors in the outfit. | 100.0% (1096) | 89 |
| `region` | Geographic region identified from context ('EU' or 'US'). | 100.0% (1096) | 2 |
| `seasonality` | The inferred season. | 92.1% (1009) | 5 |
| `sentiment_or_vibe` | The aesthetic vibe described. | 91.8% (1006) | 393 |
| `setting` | The setting or background of the photo. | 92.1% (1009) | 5 |
| `silhouette` | The overall outline or shape of the outfit. | 25.4% (278) | 6 |
| `source_url` | The URL of the webpage where the image was found. | 100.0% (1096) | 178 |
| `subculture_aesthetic` | Specific internet aesthetics or micro-trends. | 3.1% (34) | 20 |
| `top_garment_type` | The type of top being worn. | 91.2% (1000) | 500 |
| `waistline_rise` | The rise of the bottoms. | 14.1% (155) | 2 |
| `weather_conditions` | Inferred weather. | 73.7% (808) | 34 |
