...
**Last Updated:** 2026-07-18 04:00:53 UTC
...
|----------|-------------|-----------|-----------------|
| `accessories` | List of visible accessories. | 71.4% (284) | 201 |
| `age_group` | Visually estimated age bracket. | 78.1% (311) | 5 |
| `bottom_garment_type` | The type of bottom being worn. | 50.8% (202) | 116 |
| `brand_mentions` | Fashion brands explicitly mentioned. | 8.5% (34) | 30 |
| `clothing_fit` | The overall fit of the clothing. | 78.1% (311) | 4 |
| `clothing_style` | The primary fashion style. | 100.0% (398) | 112 |
| `color_palette_type` | The overall color theory of the outfit. | 78.1% (311) | 5 |
| `confidence_score` | Model confidence score (0.0 to 1.0). | 100.0% (398) | 7 |
| `date_scraped` | Automatically injected date. | 100.0% (398) | 35 |
| `fabric_textures` | Visually inferred materials. | 78.1% (311) | 139 |
| `focal_point` | The standout piece that draws the eye. | 78.1% (311) | 232 |
| `footwear_type` | The type of shoes being worn. | 33.4% (133) | 79 |
| `gender` | The perceived gender of the subject. | 100.0% (398) | 3 |
| `hair_color` | Subject's hair color. | 77.1% (307) | 32 |
| `hairstyle` | The primary hairstyle of the subject. | 100.0% (398) | 236 |
| `image_url` | Image URL of the subject (GDPR compliant). | 1.8% (7) | 6 |
| `is_trendsetter` | True if celebrity/model/artist, False if regular person. | 100.0% (398) | 2 |
| `layering_complexity` | Scale from 1 (simple) to 5 (heavy layering). | 78.1% (311) | 4 |
| `makeup_style` | Subject's makeup style. | 78.1% (311) | 15 |
| `patterns` | Patterns visible on the clothing. | 78.1% (311) | 101 |
| `pose_or_activity` | What the subject is doing. | 78.1% (311) | 106 |
| `price_segment` | Inferred price segment. | 78.1% (311) | 4 |
| `primary_colors` | List of dominant colors in the outfit. | 100.0% (398) | 62 |
| `region` | Geographic region identified from context ('EU' or 'US'). | 100.0% (398) | 2 |
| `seasonality` | The inferred season. | 78.1% (311) | 5 |
| `sentiment_or_vibe` | The aesthetic vibe described. | 77.6% (309) | 143 |
| `setting` | The setting or background of the photo. | 78.1% (311) | 5 |
| `source_url` | The URL of the webpage where the image was found. | 100.0% (398) | 94 |
| `top_garment_type` | The type of top being worn. | 77.1% (307) | 211 |
| `weather_conditions` | Inferred weather. | 57.8% (230) | 21 |
